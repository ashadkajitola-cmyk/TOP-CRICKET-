...
<script>
    ...
    function checkAdminAccess() {
        ...
        // Strictly check if active subscription exists and hasn't expired
    ...
    function buySubscription(cost, planName, extraDays, extraMins) {
        ...
        userRef.once('value', (snapshot) => {
            ...
            // Calculate new sub expiry time correctly (add to current expiry if active, else current time)
